-- OCR SaaS Tables - linked to existing containers table
-- Run this in your Supabase project: bsaffwfvnnyaihmrmqwt
...
CREATE TABLE IF NOT EXISTS ocr_documents (
    ...
    original_path TEXT,
    container_number TEXT REFERENCES containers(container_number) ON DELETE SET NULL,
    ...
    file_hash TEXT,
    source_system TEXT DEFAULT 'file_watcher',
...
CREATE INDEX IF NOT EXISTS idx_ocr_documents_container ON ocr_documents(container_number);
